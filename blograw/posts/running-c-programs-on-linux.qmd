...
For your MS course, **VS Code** is probably the most practical choice—it gives you syntax highlighting, error squiggles, and integrated `gdb` debugging without the overhead of a full IDE.
