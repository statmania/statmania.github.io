...
You get beautiful **elemental maps**. For example, if you scan an old coin:
*   One map might show **copper** (in red) everywhere.
*   Another map might show **tin** (in blue) only in certain areas, revealing it's actually bronze.
*   Another might show **silver** (in green) only in the raised design, proving it was silver-plated.
