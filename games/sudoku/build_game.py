...
<style>
  ...
  .board-wrap { background: var(--card); border: 1px solid rgba(255,255,255,0.08);
                border-radius: 14px; padding: 16px; margin-bottom: 20px; display: flex;
  ...
  .rules-hint { text-align: center; font-size: 0.8rem; color: var(--muted); margin: -8px 0 20px; }
</style>
</head>
        ...
        <section class="py-12 px-4 sm:px-6 lg:px-8 bg-slate-50">
            <div class="container mx-auto max-w-3xl">
                <div class="sm-card p-8">
                    ...
                    <p class="rules-hint">Every row and every box uses each number once. Columns never repeat a number either &mdash; on rectangular boards a column just won't contain <em>every</em> number, since it's shorter than the digit range.</p>
                </div>
            </div>
        </section>
