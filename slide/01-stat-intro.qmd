...
>- Qualitative $\rightarrow$ non-numeric
>- Quantitative $\rightarrow$ numeric
...
| Scale    | Measure property           | Mathematical operators         |
|----------|----------------------------|--------------------------------|
| Nominal  | Classification, membership | =, ≠                           |
| Ordinal  | Comparison, level          | all above and >, <               |
| Interval | Difference, affinity       | all above and +, −               |
| Ratio    | Magnitude, amount          | all above and ×, ÷               |
...
## Double Sum: Product across Cities {.smaller}

A company sells 3 products (P1, P2, P3) in 4 cities (C1, C2, C3, C4).
The monthly sales (in thousands of dollars) are:
